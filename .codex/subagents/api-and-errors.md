...
name: api-and-errors
description: >-
  API clients and error-handling specialist. Use when reviewing fetch layers, axios usage, error surfaces, and user-visible failure modes in PRs.
model: inherit
readonly: true
---
...
**`.cursor/docs/workflows/agent-rubrics/review/05-api-and-errors.md`**

...
description: >-
  Tests and observability specialist. Use when reviewing Jest/RTL tests, Sentry, logging, and coverage in PRs.
model: inherit
readonly: true
---
...
**`.cursor/docs/workflows/agent-rubrics/review/08-testing-observability.md`**

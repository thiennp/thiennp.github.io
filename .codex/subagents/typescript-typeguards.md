---
name: typescript-typeguards
description: >-
  TypeScript types and type-guard specialist. Use when reviewing DTOs, is* guards, API boundaries, and strict typing in PRs.
model: inherit
readonly: true
---
...
**`.cursor/docs/workflows/agent-rubrics/review/03-typescript-typeguards.md`**

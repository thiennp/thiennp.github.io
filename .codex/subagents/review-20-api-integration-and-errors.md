---
name: review-20-api-integration-and-errors
description: "Check **changed** client API code against **project** API patterns (`api-request-pattern`, `api-integration-pattern`, `api-error-handling-patterns`, `api-response-processing`, `api-validation-patterns`)."
model: inherit
readonly: true
---

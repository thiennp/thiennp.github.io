---
name: review-22-state-management
description: "Review **changed** state code (Zustand/Context/local state) using `state-representation-standards`, `zustand-memo-optimization`, `server-side-state-isolation` where relevant."
model: inherit
readonly: true
---

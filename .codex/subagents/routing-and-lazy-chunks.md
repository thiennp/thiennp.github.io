---
name: routing-and-lazy-chunks
description: >-
  Routing and code-splitting specialist. Use when reviewing react-router, lazy chunks, and navigation in PRs.
model: inherit
readonly: true
---
...
**`.cursor/docs/workflows/agent-rubrics/review/10-routing-and-lazy-chunks.md`**

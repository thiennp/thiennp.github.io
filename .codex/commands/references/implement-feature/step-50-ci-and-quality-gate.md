...
Run the project command **`/command-verify-typecheck-and-ci-test`** (see **`.cursor/commands/command-verify-typecheck-and-ci-test.md`**) or execute the same shell from that file.

...
description: Runs the EnergyCenter mandatory two-pass local RAG workflow before substantive answers or edits that touch docs, rules, or frontend work.
---

# Local RAG Two-Pass Workflow

## When this applies

Follow this before reading **`frontend/src/`**, editing application code, or
giving substantive technical answers in repositories that provide the local RAG
tooling. Pure meta replies are exempt. See **`.cursorrules`** and
**`.cursor/rules/rag-local-corpus.mdc`** for the full hard gate.

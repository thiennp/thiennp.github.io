---
name: file-structure-and-components
description: >-
  File structure and component scaffold specialist. Use when validating new files against feature layout and component patterns.
model: inherit
readonly: false
---
...
**`.cursor/docs/workflows/agent-rubrics/implement/03-file-structure-and-components.md`**

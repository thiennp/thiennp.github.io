...
description: >-
  Security-focused code reviewer. Use when reviewing auth, PII, injections, XSS, secrets, or sensitive flows in PRs.
model: inherit
readonly: true
---
...
**`.cursor/docs/workflows/agent-rubrics/review/06-security-review.md`**

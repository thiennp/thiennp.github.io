---
name: review-10-srp-and-layering
description: "Verify **separation of concerns** in **changed** code: UI vs hooks vs utils vs services/API vs constants/maps."
model: inherit
readonly: true
---
...
Only **new/modified** files vs `origin/release...HEAD`. Cite `.cursor/rules/code-standard.mdc` (file boundaries: constants, maps, testable units) when relevant.

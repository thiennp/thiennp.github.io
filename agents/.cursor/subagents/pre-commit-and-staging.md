---
name: pre-commit-and-staging
description: >-
  Pre-commit staging specialist. Use when validating git add scope, commit splits, and POST-/00000 message format before commit.
model: inherit
readonly: false
---
...
**`.cursor/docs/workflows/agent-rubrics/implement/04-pre-commit-and-staging.md`**

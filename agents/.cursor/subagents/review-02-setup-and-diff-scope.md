---
name: review-02-setup-and-diff-scope
description: "Ensure review material matches **what merges**: up-to-date `release` base, correct three-dot diff, PR metadata."
model: inherit
readonly: true
---
...
- Optional: output of `pnpm tsx .cursor/scripts/bb/pr-changes.ts <pr-id>`.

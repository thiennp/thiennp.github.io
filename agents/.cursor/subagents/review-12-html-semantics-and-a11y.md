---
name: review-12-html-semantics-and-a11y
description: "Review **changed markup** for semantics and basic a11y (labels, roles, headings, interactive elements)."
model: inherit
readonly: true
---
...
- [ ] **Interactive elements:** prefer **styleguide** `button` / `input` primitives over raw HTML if project mandates (`code-standard.mdc` § design system).

...
description: >-
  React hooks, performance, and re-render specialist. Use when reviewing useEffect, useMemo, useCallback, Zustand selectors, and memoization in PRs.
model: inherit
readonly: true
---
...
**`.cursor/docs/workflows/agent-rubrics/review/02-react-hooks-performance.md`**

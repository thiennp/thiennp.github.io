...
- `sentry-chrome-tab-snapshot` - Sentry Chrome Tab Snapshot: heartbeat automation that extracts the CHECK24 Sentry issue list from the verified Chrome profile and syncs it into the localhost triage report.

...
- `fix-slack-security-dependency-threads` - Daily-vulnerabilities-fix: paused cron automation for daily security dashboard scan/fix + Jira/PR tracking.
...
- `sentry-jira-cursor-triage-loop` - Sentry Jira Cursor Triage Loop: paused heartbeat automation for Sentry triage + Jira ticket creation workflow.

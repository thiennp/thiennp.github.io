...
- `agent-report-server-guard` - Agent Report server guard: paused cron automation that checks every 30 minutes and starts the Agent Report server if it is down.
